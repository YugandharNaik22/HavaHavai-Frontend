...
import { View, Flex, Heading, Button,  DialogTrigger, Dialog,TextField,FileTrigger,Divider,Content,ButtonGroup } from '@adobe/react-spectrum';
import TerminalCard from './TerminalCard';
import {context} from "../context/ContextProvider"
import useAddTerminal from '../hooks/addTerminal';
...
const Terminal = () => {
  ...
  const fetchTerminals = async () => {
    try {
      const res = await axios.get(`${pic}/all-terminals`);
